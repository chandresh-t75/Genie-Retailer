    ...
    return (
      <View style={{ flex: 1 }} className="bg-white">
        <ScrollView >
          ...
          <View className="flex flex-row gap-[40px] mt-[20px] px-[32px] pb-[50px] justify-center">
            ...
            <ScrollView horizontal={true} showsHorizontalScrollIndicator={false} style={{ maxHeight: 240 }}>
              <View className="flex-row  gap-[10px] mt-[25px] px-[32px]">
                {imagesLocal.map((image, index) => (
                  ...
                  >
                    <View
                      className={`rounded-3xl border-[1px] border-slate-400 `}
                    >
                      <Image
                        source={{ uri: image }}
                        width={140}
          ...
          <View style={{ flex: 1 }} className="absolute  left-0 right-0 bottom-0 z-50 h-screen shadow-2xl " >
            ...
            <View className="bg-white absolute bottom-0 left-0 right-0 ">
              ...
              <TouchableOpacity onPress={() => { takePicture(); setAddMore(false); }}>
                ...
                <Text className="w-[90%] items-center flex-row justify-between pl-[15px] pr-[30px] mx-[20px] pb-[30px]" style={{ fontFamily: "Poppins-Regular" }}>Please take a real photo of products for customers' shopping reference.</Text>
